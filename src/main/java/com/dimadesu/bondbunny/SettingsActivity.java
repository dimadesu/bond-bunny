...
public class SettingsActivity extends Activity {
    ...
    private static final String PREF_MOBLINK_NAME = "moblink_name";
    ...
    private EditText editMoblinkName;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editMoblinkName = findViewById(R.id.edit_moblink_name);
        ...
        editMoblinkName.setText(prefs.getString(PREF_MOBLINK_NAME, "Bond Bunny"));
        ...
        editMoblinkName.addTextChangedListener(new TextWatcher() {
            @Override public void beforeTextChanged(CharSequence s, int start, int count, int after) {}
            @Override public void onTextChanged(CharSequence s, int start, int before, int count) {}
            @Override public void afterTextChanged(Editable s) {
                prefs.edit().putString(PREF_MOBLINK_NAME, s.toString().trim()).apply();
            }
        });
